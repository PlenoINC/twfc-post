...
class Requests{
    ...
    function __construct() 
    {
        ...
        $this->action_form                  = addslashes(strip_tags($_POST['action']));
    ...
    function varPost()
    {
        // se o for o formulario do facebook
        if($this->action_form == 'form-facebook'){
            
            // se o botão salvar for clicado salva/atualiza os dados 
            if($this->btn_save){
            ...
            // se existir os dados da app do facebook 
            // e não for fabcallback faz/solicita a conecsão
            if( isset($optionApp['facebookappid']) and $optionApp['facebookappsecret'] and $this->fbcallback == ''  ){            
                ...
                // gera o botão para autorizar a publuicação
            ...
            $getToken =  get_option('twfcfacebook_token');
        ...
        // se o for o formulario do twiiter
        if($this->action_form == 'form-twitter' && $this->btn_save){
            ...
            if(!$this->error){
                ...
                // salva/atualiza os registros
                update_option('twfc_app_twitter', array(
